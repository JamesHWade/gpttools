...
The current version require R 4.2 or greater because of a current dependency. If you are using an older version of R, you can get around this dependency by installing `{openai}` from my fork of the [original package](https://github.com/irudnyts/openai). Here's how to do that:
