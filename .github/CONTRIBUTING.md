...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("JamesHWade/gpttools", fork = TRUE)`.
...
Please note that the gpttools project is released with a
